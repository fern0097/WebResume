!(function (e, t) {
      ...
      q = new _(z, {
        ...
        touchEnd: function () {
          if (r) {
            ...
            if (!(t > 29 && f))
              return t < 29 && i < 25
                ? (h(Y, "greset"), (Y.style.opacity = 1), B(g))
                : void 0;
            e.close();
          }
        },
    ...
    "file" == u && (u = "http"),
      ...
      S(this.settings.plyr.js, "Plyr", function () {
        ...
        C.on("ready", function (e) {
          ...
          C.on("enterfullscreen", R),
          C.on("exitfullscreen", R);
      });
  }
  function R(e) {
  ...
  function G(e, t, i, n) {
    ...
    if (
      d &&
      (k(d) && (s = m('<div class="ginlined-content">'.concat(d, "</div>"))),
      C(d))
    ) {
          ...
          },
          {
            ...
            value: function () {
              ...
              h(s, "glightbox-open"),
                ...
                K && this.settings.touchNavigation && W(this),
                ...
                if (
                  ...
                  if (
                    ...
                    if (l <= 768) {
                      ...
                      g.setAttribute(
                        "style",
                        "max-height: calc(100vh - ".concat(u, "px)")
                      ),
                        s.setAttribute(
                          "style",
                  ...
                  if (i) {
                    ...
                    if (
                      ...
                      (i.parentNode.style.maxWidth = "".concat(S)),
                        r &&
                          s.setAttribute("style", "max-width: ".concat(S, ";"));
                  }
                }
              }
            },
